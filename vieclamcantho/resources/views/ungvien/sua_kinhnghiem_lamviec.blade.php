...
<div class="modal-body">
    <form id="frmEditKN" class="form-horizontal" action="{{URL::to('/update-kinhnghiem-lamviec/'.$detail->taikhoan_id.'/'.$detail->kinhnghiem_id)}}" method="post">
        @csrf
        
        <div class="form-group">
            <label class="col-sm-2 control-label">Tên công ty</label>
            <div class="col-sm-10">
                <input type="text" name="tencty" class="form-control" value="{{$detail->kinhnghiem_congty}}" required="">
            </div>
        </div>
        <div class="form-group">
            <label class="col-sm-2 control-label">Chức danh</label>
            <div class="col-sm-10">
                <input type="text" name="chucdanh" class="form-control" value="{{$detail->kinhnghiem_chucdanh}}" required="">
            </div>
        </div>
        <div class="form-group">
                    ...
                    <div class="col-sm-5 col-xs-5">
                        <select data-placeholder="Tháng" class="form-control" name="thangFrom" required="">
                            <option value="">Tháng</option>
                                             ...
                                             @if($th->thang_thang == $detail->kinhnghiem_thangbd)
                    ...
                    <div class="col-sm-5 col-xs-5">
                        <select data-placeholder="Năm" class="form-control" name="namFrom" required="">
                            <option value="">Năm</option>
                                             ...
                                             @if($na->nam_nam == $detail->kinhnghiem_nambd)
                ...
                <div class="row mt5" id="tgTo">
                    ...
                    <div class="col-sm-5 col-xs-5">
                        <select data-placeholder="Tháng" class="form-control" name="thangTo" id="thangTo" required="">
                            <option value="">Tháng</option>
                                                           @foreach($thang as $key => $th)
                                             @if($th->thang_thang == $detail->kinhnghiem_thangkt)
                                                            <option value="{{$th->thang_thang}}" selected>
                                    Tháng {{$th->thang_thang}}                                </option>
                                            @else
                                            <option value="{{$th->thang_thang}}" >
                    ...
                    <div class="col-sm-5 col-xs-5">
                        <select data-placeholder="Năm" class="form-control" name="namTo" id="namTo" required="">
                            <option value="">Năm</option>
                                                           @foreach($nam as $key => $na)
                                             @if($na->nam_nam == $detail->kinhnghiem_namkt)
                                                            <option value="{{$na->nam_nam}}" selected>
                                    Năm {{$na->nam_nam}}                                </option>
                                            @else
                                            <option value="{{$na->nam_nam}}" >
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <textarea class="form-control" cols="2" style="width: 100%" maxlength="500" name="mota" >{{$detail->kinhnghiem_mota}}</textarea>
            </div>
        </div>
