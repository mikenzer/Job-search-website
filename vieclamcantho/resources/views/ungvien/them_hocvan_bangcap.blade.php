...
<div class="modal-body">
    <form id="frmEditTD" class="form-horizontal" action="{{URL::to('/add-hocvan-bangcap/'.$detail->taikhoan_id)}}" method="post">
        @csrf
        <div class="form-group">
            <label class="col-sm-2 control-label">Tên bằng cấp</label>
            <div class="col-sm-10">
                <input type="text" name="bangcap" class="form-control" required="">
            </div>
        </div>
        <div class="form-group">
