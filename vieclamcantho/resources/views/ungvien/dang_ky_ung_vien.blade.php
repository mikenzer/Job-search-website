        ...
        <div class="pageRegister py-5">
            ...
            <div class="container">
                <div class="row" id="divDK">
                    <div class="col-md-6">
                        <div class="registerCard registerAnimation registerCard">
                            <div class="registerInner">
                                <div class="registerItem">
                                    ...
                                    <div class="registerSubTitle">
                                        Nếu đã có tài khoản, xin vui lòng <a href="{{URL::to('/dang-nhap-ung-vien')}}" >Đăng
                                        nhập tại đây</a>
                                    </div>
                                    <?php
                                        ...
                                        ?>
                                    <form class="modalOverideForm" action="{{URL::to('/them-ungvien')}}" method="post">
                                        {{csrf_field()}}
                                        <div class="form-input-animation">
                                            <input name="taikhoan_email" class="form-text" tabindex="1"
                                                type="email" required="" autocomplete="off"
                                                id="taikhoan_email">
                                            <label for="email">
                                            <span ><i class="fal fa-envelope"></i>Email đăng nhập <sup>*</sup></span>
                                            </label>
                                        </div>
                                        <div class="row row-10">
                                            <div class="col-md-6">
                                                <div class="form-input-animation">
                                                    <a data-id="taikhoan_matkhau" class="view-password btnViewPass"
                                                        href="javascript:void(0)"><i class="far fa-eye"></i></a>
                                                    <input name="taikhoan_matkhau" class="form-text" tabindex="2"
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-input-animation">
                                                    <a data-id="nhaplaimatkhau" class="view-password btnViewPass"
                                                        href="javascript:void(0)"><i class="far fa-eye"></i></a>
                                                    <input name="nhaplaimatkhau" class="form-text validPass" tabindex="3"
                                                        type="password" required="" autocomplete="off"
                                                        id="nhaplaimatkhau" data-id="taikhoan_matkhau">
                                                    <label for="nhaplaimatkhau">
                                                    <span><i class="fal fa-lock"></i>Nhập lại mật khẩu</span>
                                                    </label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-input-animation">
                                            <input name="taikhoan_ten"
                                                class="form-text "
                                                type="text" required="" autocomplete="off" tabindex="4"
                                                id="taikhoan_ten" value="">
                                            <label for="taikhoan_ten">
                                            <span><i class="fal fa-id-card"></i>Họ tên</span>
                                            </label>
                                        </div>
                                        <div class="row row-10">
                                            <div class="col-md-6">
                                                <div class="form-input-animation">
                                                    <input name="taikhoan_ngaysinh" onfocus="(this.type='date')"
                                                        class="form-text"
                                                        max='2007-05-25'
                                                        oninvalid="this.setCustomValidity('Ứng viên phải lớn hơn 15 tuổi')"
                                                        oninput="setCustomValidity('')"
                                                        type="text" required="" autocomplete="off" tabindex="4"
                                                        id="taikhoan_ngaysinh" value="">
                                                    <label for="taikhoan_ngaysinh">
                                                    <span><i class="fal fa-calendar-alt"></i>Ngày sinh</span>
                                                    </label>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <label style="position: relative; top: 14px">
                                                <span><i class="fal fa-venus-mars mr-1"></i> Giới tính</span>
                                                </label>
                                                <div class="form-check form-check-inline"
                                                    style="height: 44px; position: relative; top: 14px; margin-left: 10px">
                                                    <input class="form-check-input" type="radio" name="taikhoan_gioitinh"
                                                        id="male" value="1" required>
                                                    <label class="form-check-label" for="male">Nam</label>
                                                </div>
                                                <div class="form-check form-check-inline"
                                                    style="height: 44px; position: relative; top: 14px">
                                                    <input class="form-check-input" type="radio" name="taikhoan_gioitinh"
                                        ...
                                        <div class="form-input-animation">
                                            <input name="taikhoan_sdt" class="form-text onlyNum" tabindex="5"
                                                type="tel" required="" autocomplete="off" maxlength="11" minlength="10"
                                                id="taikhoan_sdt">
                                            <label for="taikhoan_sdt">
                                            <span><i class="fal fa-phone-alt"></i>Số điện thoại</span>
                                            </label>
                                        </div>
                                        <div class="form-input-animation">
                                            <input name="taikhoan_diachi" class="form-text" tabindex="6"
                                                type="text" required="" autocomplete="off"
                                                id="taikhoan_diachi">
                                            <label for="taikhoan_diachi">
                                            <span><i class="fal fa-map-marked"></i>Địa chỉ</span>
                                            </label>
                                        </div>
                                        <div class="custom-control custom-checkbox mt-4 form-group">
                                            <input type="checkbox" class="custom-control-input" id="ckbAgree" name="ckbAgree"
                                                required>
                                        ...
                                        <div class="form-group mb-0 text-center">
                                            <button type="submit" id="btnDkUv"
                                                class="btn button-theme button-blue rounded-0 size-095rem fw-500 ">
                                            ĐĂNG KÝ ỨNG VIÊN
                                            </button>
                                        </div>
                                    </form>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="registerDesc customScroll position-relative">
                            <div class="registerDescInner">
                                ...
                                <ul class="list-unstyled mb-0 size-095rem">
                                    <li><i class="fal fa-check-circle blue-color mr-1"></i>+ 1.500.000 công việc được cập
                                        nhật thường xuyên
                                    </li>
                                    ...
                                    <li><i class="fal fa-check-circle blue-color mr-1"></i>Nhận bản ưu tiên công việc phù
                                        hợp
                                        định kỳ
                                    </li>
                                </ul>
