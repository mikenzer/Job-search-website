...
<html lang="en" xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <meta property="og:url" itemprop="url" content="https://vieclamcantho.com.vn/"/>
        ...
        <link rel="stylesheet" href="https://cdn.vieclamcantho.com.vn/view/vieclam_pc/assets/css/bundle-uv.css?ver=325">
          <script type="text/javascript"
            src="https://cdn.vieclamcantho.com.vn/view/vieclam_pc/assets/js/bundle-uv.js?ver=325"></script>
    ...
    <body >
                ...
                <div class="container">
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <?php
                            ...
                            ?>
                        <ul class="nav navbar-nav">
                            <li class="dropdown dropdownTheme dropdownAccount">
                                <a class="dropdown-toggle d-md-flex align-items-center justify-content-center size-085rem text-white transition-03"
                                    data-toggle="dropdown" href="javascript:void(0)" role="button"
                                    aria-haspopup="true" aria-expanded="false">
                                <i class="fas fa-user mr-1 nav-item_link__icon"></i>
                                <span>Tài khoản</span>
                                </a>
                                <div class="dropdown-menu">
                                    @foreach($all_taikhoan as $key => $uv)
                                    @if($uv->taikhoan_id == $taikhoan_id)
                                    <a class="dropdown-item" href="javascript:void(0)">
                                    Xin chào ứng viên <br>{{$uv->taikhoan_ten}}                 </a>
                                    @endif
                                    @endforeach
                                    <a class="dropdown-item"
                                        href="{{URL::to('/ung-vien/'.$taikhoan_id)}}">
                                    <i class="fal fa-address-card"></i>Trang quản lý
                                    </a>
                                     <!-- <a class="dropdown-item xemCVHead tdAjax"
                                        data-id="86560" data-type="uv"
                                        href="https://vieclamcantho.com.vn/nhan-hs86560.html">
                                         <i class="fal fa-clipboard-list-check"></i>Xem CV
                                        </a> -->
                                        <a class="dropdown-item xemCVHead"
                                        href="{{URL::to('/tao-cv')}}">
                                         <i class="fal fa-file-alt"></i>Tạo CV
                                        </a>
                                        <a class="dropdown-item" href="{{URL::to('/thong-tin-ca-nhan/'.$taikhoan_id)}}">
                                         <i class="fal fa-edit"></i>Chỉnh sửa CV
                                        </a>
                                        <!-- <a class="dropdown-item" href="https://vieclamcantho.com.vn/ung-vien/viec-lam-da-nop">
                                         <i class="fal fa-building"></i>Việc làm đã nộp
                                        </a>
                                        <a class="dropdown-item" href="https://vieclamcantho.com.vn/ung-vien/viec-lam-da-luu">
                                         <i class="fal fa-heart"></i>Việc làm đã lưu
                                        </a> -->
                                    <a class="dropdown-item" href="{{URL::to('/dang-xuat')}}">
                                    <i class="fal fa-sign-out-alt"></i>Thoát
                                    </a>
                                </div>
                            </li>
                        </ul>
                               ...
                               <div class="dropdown-menu">
                                @foreach($all_taikhoanntd as $key => $ntd)
                                    @if($ntd->ntd_id == $ntd_id)
                                                            <a class="dropdown-item" href="javascript:void(0)">
                                    Xin chào nhà tuyển dụng <br>    {{$ntd->ntd_tencongty}}                       </a>
                                    @endif
                                @endforeach
                                <a class="dropdown-item" href="{{URL::to('/nha-tuyen-dung/home')}}">
                                    <i class="fal fa-cog"></i>Trang quản lý
                                </a>
                                <a class="dropdown-item" href="{{URL::to('/nha-tuyen-dung/trang-cong-ty/'.$ntd_id)}}">
                                    <i class="fal fa-building"></i>Trang công ty
                                </a>
                                <a class="dropdown-item" href="{{URL::to('/nha-tuyen-dung/dang-tin')}}">
                                    <i class="fal fa-pen-square"></i>Đăng tin tuyển dụng
                                </a>
                                <a class="dropdown-item" href="{{URL::to('/nha-tuyen-dung/quan-ly-tin')}}">
                                    <i class="fal fa-list-ul"></i>Các tin đã đăng
                                </a>
                                <a class="dropdown-item" href="{{URL::to('/nha-tuyen-dung/cap-nhat-tai-khoan')}}">
                                    <i class="fal fa-edit"></i>Thông tin tài khoản
                                </a>
                                <!-- <a class="dropdown-item" href="https://vieclamcantho.com.vn/nha-tuyen-dung/ho-so#m">
                                    <i class="fal fa-clipboard-list-check"></i>Hồ sơ đã nộp
                                </a> -->
                                <!-- <a class="dropdown-item" href="https://vieclamcantho.com.vn/nha-tuyen-dung/ho-so-da-luu#m">
                                    <i class="fal fa-heart"></i>Hồ sơ yêu thích
                                </a> -->
                                <!-- <a class="dropdown-item openModalNapTien" href="javascript:void(0)">
                                    <i class="fal fa-usd-circle"></i>Nạp số dư
                                </a> -->
                                <!-- <a class="dropdown-item" href="https://vieclamcantho.com.vn/phi-dang-tin-vip">
                                    <i class="fal fa-coin"></i>Nâng cấp VIP
                                </a> -->
                                <a class="dropdown-item" href="{{URL::to('/dang-xuat-ntd')}}">
                                    <i class="fal fa-sign-out-alt"></i>Thoát
                                </a>
                                                    </div>
                            </li>
                    ...
                    <div class="modal-body">
                        <div class="row row-10">
                            ...
                            <div class="login-ungvien col-sm-6">
                                <div class="modalOverideInner position-relative h-100">
                                    <form action="{{URL::to('/dang-nhap-ung-vien')}}" class="modalOverideForm frmLogin" name="frm-login-uv"
                                        id="frm-login-uv" method="post">
        ...
        <div class="search-bar position-relative overflow-hidden mb-3">
            <form name="frmSearch" id="frmSearch" action="{{URL::to('/search')}}" method="post">
                @csrf
                <div class="container">
                            ...
                            <div class="col-md-4">
                                <div class="form-group position-relative mb-0 noidung">
                                    <input type="text" class="form-control rounded-0 transition-03"
                                        placeholder="Tên công việc" value="" name="searchStr">
                                </div>
                            </div>
                            <div class="col-md-8">
                                <div class="row row-5 align-items-center">
                                    <div class="col-md-2">
                                        <div class="form-group position-relative mb-0">
                                            <button type="submit" class="form-control rounded-0 btn bg-orange transition-03"><i
                                                class="fal fa-search"></i>Tìm
                                            </button>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="row row-5 mt-2">
                            <div class="col-md-8">
                                <div class="search-desc">
                                    <b>Sàn Giao Dịch Việc Làm Cần Thơ</b>
                                </div>
                            </div>
                            <div class="col-md-4 text-right d-flex align-items-center justify-content-end">
                                <div class="search-reset">
                                    <a href="javascript:void(0)" style="display:none;" class="text-white"
                                        id="reset-search">
        ...
        <script>
            ...
            const _URLNOW = 'https://vieclamcantho.com.vn/';
            URLNOW = 'https://vieclamcantho.com.vn/';
        ...
        <script type="text/javascript" src="https://cdn.vieclamcantho.com.vn/view/vieclam_pc/assets/js/bundle-ntd.js?ver=324"></script>
         <link rel="stylesheet" href="https://cdn.vieclamcantho.com.vn/view/vieclam_pc/assets/css/bundle-ntd.css?ver=324">
