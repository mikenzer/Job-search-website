                                ...
                                <div class="col-md-10">
                                    <div class="search-content">
                                        ...
                                        <div class="search-address">
                                            <a href="" data-toggle="tooltip" title="" class="size-09rem text-uppercase text-gray d-inline-block text-ellipsis" data-original-title="Công Ty TNHH Liên Doanh Hasan Dermapharm">{{$dangtin->ntd_tencongty}}</a>
