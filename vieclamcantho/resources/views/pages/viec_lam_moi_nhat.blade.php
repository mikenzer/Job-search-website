                            ...
                            <div class="row row-10">
                                <div class="col-md-2">
                                    <div class="search-avatar mx-auto">
                                        <a href="{{URL::to('/chi-tiet-tuyen-dung/'.$dangtin->dangtin_id)}}" data-id="32735" data-type="td" class="boxItemBackground tdAjax" style="display: flex; background-image: url(&quot;{{URL::to('/public/upload/nhatuyendung/'.$dangtin->ntd_logo)}}&quot;);"></a>
                                    </div>
                                </div>
                                <div class="col-md-10">
                                    <div class="search-content">
                                        ...
                                        <div class="search-address">
                                            <a href="{{URL::to('/nha-tuyen-dung/trang-cong-ty/'.$dangtin->ntd_id)}}" data-toggle="tooltip" title="" class="size-09rem text-uppercase text-gray d-inline-block text-ellipsis" data-original-title="Công Ty TNHH Liên Doanh Hasan Dermapharm">{{$dangtin->ntd_tencongty}}</a>
