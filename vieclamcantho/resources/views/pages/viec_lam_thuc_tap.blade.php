                                ...
                                <div class="col-md-10">
                                    <div class="search-content">
                                        ...
                                        <div class="search-address">
                                            <a href="{{URL::to('/nha-tuyen-dung/trang-cong-ty/'.$dangtin->dangtin_id_ntd)}}" data-toggle="tooltip" class="size-09rem text-uppercase text-gray d-inline-block text-ellipsis" title="{{$ntd->ntd_tencongty}}">{{$ntd->ntd_tencongty}}</a>
