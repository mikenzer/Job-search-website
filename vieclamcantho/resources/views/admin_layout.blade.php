                ...
                <div class="leftside-navigation">
                    <ul class="sidebar-menu" id="nav-accordion">
                        ...
                        <li class="sub-menu">
                            ...
                            <ul class="sub">
                                <li><a href="{{URL::to('/add-cv')}}">Thêm CV</a></li>      
                                <li><a href="{{URL::to('/manage-cv')}}">Liệt kê CV</a></li>                          
                            </ul>
                        </li>
                        <li class="sub-menu">
                            <a href="javascript:;">
                            ...
                            <ul class="sub">
                                <li><a href="{{URL::to('/add-job')}}">Thêm ngành nghề</a></li>      
                                <li><a href="{{URL::to('/manage-job')}}">Liệt kê ngành nghề</a></li>                          
                            </ul>
                        </li>
                        ...
                        <li class="sub-menu">
                            ...
                            <ul class="sub">
                                <li><a href="{{URL::to('/add-jobtd')}}">Thêm ngành nghề tuyển dụng</a></li>      
                                <li><a href="{{URL::to('/manage-jobtd')}}">Liệt kê ngành nghề tuyển dụng</a></li>                          
                            </ul>
                        </li>
                        </li>
                        <!-- <li class="sub-menu">
